...
weight-stationary systolic array: A is M×8 signed INT8 (M = 1..64), W is 8×8
...
| 0x0200–0x03FC | activation buffer | row m in words {2m, 2m+1} |
| 0x0400–0x05FC | result buffer | same packing as activations |
